	...
	<form action="loan.ku" method="post">
		...
		<!-- 	<div class="form-group">
			...
			<div class="form-group">
				...
				<select class="form-control" required="required" name="selectLocation">
			...
			<input type="text" placeholder="Enter Vehicle Price" required="required">
			</div>
			<button type="submit"class="btn btn-outline-primary btn-block" >Check Vehicle</button>
		</div>
	</form>
</body>
</html>